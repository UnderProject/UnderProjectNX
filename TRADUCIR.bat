...
tools\hactool.exe -k keys.dat "%CD%\tools\extracted\eddd7cfa3cdca6623f31cf2f20e9257e.nca" --titlekey="E569D60DE352C21297DA0E66CFDFD08F" --romfsdir="%CD%\tools\extracted\romfs"
